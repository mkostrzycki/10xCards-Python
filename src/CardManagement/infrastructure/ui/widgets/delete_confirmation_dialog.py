...
class DeleteConfirmationDialog(ttk.Toplevel):
    ...
    def __init__(self, parent: Any, front_text: str, on_confirm: Callable[[], None], on_cancel: Callable[[], None]):
        ...
        Args:
            ...
            front_text: Front text of the flashcard to delete (for display)
    ...
    def _init_ui(self) -> None:
        ...
        # Warning message
        preview = (self.front_text[:30] + "...") if len(self.front_text) > 30 else self.front_text
