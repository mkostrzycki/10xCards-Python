...
class SettingsView(ttk.Frame):
    ...
    def _setup_ui(self) -> None:
        ...
        password_btn = ttk.Button(
            ...
            style="primary.TButton",
            command=self._open_manage_password_dialog
        )
        ...
        llm_model_btn = ttk.Button(
            ...
            style="primary.TButton",
            command=self._open_select_llm_model_dialog
        )
        ...
        theme_btn = ttk.Button(
            ...
            style="primary.TButton",
            command=self._open_select_theme_dialog
        )
    ...
    def _open_change_username_dialog(self) -> None:
        ...
        dialog = ChangeUsernameDialog(
            self,
            self.settings_model.current_username,
    ...
    def _open_manage_password_dialog(self) -> None:
        ...
        dialog = ManagePasswordDialog(
            self,
            self.settings_model.has_password_set,
    ...
    def _on_password_changed(self, current_password: Optional[str], new_password: Optional[str]) -> None:
        ...
        try:
            dto = SetUserPasswordDTO(
                user_id=self.settings_model.user_id, 
    ...
    def _open_api_key_dialog(self) -> None:
        ...
        dialog = APIKeyDialog(
            ...
            self.api_client,
            current_key,
            lambda key: self._on_api_key_changed(user.id, key)
        )
